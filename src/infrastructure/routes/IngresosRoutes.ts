...
import { IngresosAdapter } from '../adapter/ingresosAdapter.js';
import { IngresoApplication } from "../../app/ingresoApplication.js";
import { IngresoController} from '../controller/ingresosController.js';
...
//definicion de rutas
ingresoRouter.post("/ingresos", async(req: Request, res: Response)=>{
    try {
...
ingresoRouter.put("/Ingreso/:id", async (req: Request<{ id: string }>, res: Response)=>{
    try {
...
ingresoRouter.delete("/ingresos/:id", async(req: Request<{ id: string }>, res: Response)=>{
    try {
...
ingresoRouter.get("/ingresos/id/:id", async(req: Request<{ id: string }>, res: Response)=>{
    try {
...
ingresoRouter.get("/ingresos", async (req: Request, res: Response)=>{
    try {
