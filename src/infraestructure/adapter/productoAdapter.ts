...
import { Producto as ProductoDomain } from '../../domain/producto';
import {Producto as ProductoEntity} from '../entities/producto';
...
export class ProductoAdapter implements ProductoPort{
    ...
    private toDomain(Producto:ProductoEntity):ProductoDomain{
        ...
        return{
            ...
            providerId:Producto.fk_prov_id,
        }
    }
    ...
    private toEntity(Producto:Omit<ProductoDomain, "id">):ProductoEntity{
        ...
        productoEntity.fk_prov_id=Producto.providerId;
